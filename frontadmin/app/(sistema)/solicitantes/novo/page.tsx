            ...
            <div className="max-w-2xl mx-auto flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-white tracking-tight">Novo Solicitante</h1>
                            <p className="text-sm text-slate-400 mt-0.5">Preencha os dados para registrar um novo solicitante</p>
                        </div>
                    </div>
                </div>
